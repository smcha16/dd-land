...
<style>
	...
	/* list photo 변경 */
    .stats-counter {
      background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/dd/resources/files/activity/festival_background2.jpg") center center;
      background-size: cover;
      padding: 100px 0;
		...
		<div class="gy-4" style="justify-content: center; width: 100%;">
			<div class="col-lg-3 col-md-6" style="width: 100%;">
				<div class="stats-item text-center w-100 h-100">
					<div id="title"><a href="/dd/user/activity/festival/view.do">Festival</a></div>
					<div id="search">
						<form method="GET" action="/dd/user/activity/festival/view.do">
							<p>공연 일정</p>
			...
			<div class="tab-pane fade active show" id="menu-starters">
				<div class="munti-content-container">
					<c:forEach items="${list}" var="dto">
						<div class="item" onclick="location.href= '/dd/user/activity/festival/detail.do?seq=' + ${dto.festival_seq};">
							<div style="background-image: url('/dd/resources/files/activity/festival/${dto.img}');"></div>
							<div>${dto.name}</div>
