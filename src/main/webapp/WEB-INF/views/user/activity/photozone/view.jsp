...
<style>
	...
	/* list photo 변경 */
    .stats-counter {
      background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/dd/resources/files/activity/photozone_background.jpg") center center;
      background-size: cover;
      padding: 100px 0;
		...
		<div class="gy-4" style="justify-content: center; width: 100%;">
			<div class="col-lg-3 col-md-6" style="width: 100%;">
				<div class="stats-item text-center w-100 h-100">
					<div id="title"><a href="/dd/user/activity/photozone/view.do">Photozone</a></div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="tab-pane fade active show" id="menu-starters">
				<div class="munti-content-container">
					<c:forEach items="${list}" var="dto">
						<div class="item" onclick="location.href= '/dd/user/activity/photozone/detail.do?seq=' + ${dto.photozone_seq};">
							<div style="background-image: url('/dd/resources/files/activity/photozone/${dto.img}');"></div>
							<div>${dto.name}</div>
