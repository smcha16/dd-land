		...
		<div class="tab-content" data-aos="fade-up" data-aos-delay="300">
			<div class="tab-pane fade active show" id="menu-starters">
					...
					<c:forEach items="${list}" var="dto">
						<c:if test="${dto.close == 'y'}">
							<div class="item hidden" onclick="detail(${dto.shop_seq});">
								<div
									style="background-image: url('/dd/resources/files/giftshop/${dto.img}');"></div>
								<div>${dto.name }</div>
				...
				<c:if test="${closeCount == 0}">
					<div id="close-img">
						<img src="/dd/resources/files/giftshop/기프트샵운휴.png"
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item"><a class="page-link"
							href="/dd/user/shop/gift-shop/view.do?page=${pageStatus.index}">${pageStatus.index}</a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
		</ul>
