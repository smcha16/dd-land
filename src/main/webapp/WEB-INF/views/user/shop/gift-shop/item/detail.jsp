	...
	<div class="result-container">
		...
		<div class="result-item">
			...
			<sec:authorize access="isAuthenticated()">
					...
					<div>
						<button id="back-button" class="btn btn-primary cart" type="button">장바구니</button>
...
<script>
	$('.cart').click(function() {
		...
		let obj = {
				...
				ea: $("select[name='ea']").val(),
				<sec:authorize access="isAuthenticated()">
				user_seq: <sec:authentication property='principal.dto.user_seq'/>
				</sec:authorize>
			};
		...
		$.ajax({
			type: 'POST',
			url: '/dd/member/shop/gift-shop/item/cart',
