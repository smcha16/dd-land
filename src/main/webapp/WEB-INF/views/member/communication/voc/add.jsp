...
<style>
    .stats-counter {
    	background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/dd/resources/files/communication/voc.jpg") center center;
...
<main id="voc">
	<form method="POST" action="/dd/member/communication/voc/addok.do" enctype="multipart/form-data">
		...
		<table id="add-form">
			...
			<tr>
				...
				<td>
					<select name="visit_date" class="form-select">
			            <c:forEach var="date" items="${empty list ? {'없음'} : list}">
