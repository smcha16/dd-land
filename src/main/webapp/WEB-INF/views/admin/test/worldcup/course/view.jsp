				...
				<div class="row">
					<div class="col-12">
						...
						<div id="search" class="header">
                  			<form method="GET" action="/dd/admin/test/worldcup/course/view.do" class="search-form d-flex align-items-center">
...
<script>
	...
	$(document).keydown(function(event) {
	    if (event.key === 'F5') {
			location.href='/dd/admin/test/worldcup/course/view.do';
	    }
	});
