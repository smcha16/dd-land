					...
					<div class="col-12">
						...
						<!-- 검색 -->
              			...
              			<div id="search" class="header">
                  			<form method="GET" action="/dd/admin/communication/voc/view.do" class="search-form d-flex align-items-center">
									...
									<tbody>
										<c:forEach items="${list}" var="dto" varStatus="numberStatus">
											<tr>
									            ...
									            <td>
									            	<a onclick="showModal('${dto.voc_seq}', `${dto.subject}`, `${dto.content}`, '${dto.attach}', `${dto.answer}`)">
								    ...
								    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
								        ...
								        <div class="modal-content">
								            ...
								            <div class="modal-body">
							                    ...
							                    <form method="POST" action="/dd/admin/communication/voc/answer.do" id="answer-form">
							                    	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
							                    	<input type="hidden" name="voc_seq" id="voc_seq">
