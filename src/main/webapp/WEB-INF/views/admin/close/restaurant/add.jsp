     		 ...
     		 <div class="col-lg-12">
        		...
        		<div class="card">
          			<div class="card-body">
            			...
            			<form method="POST" action="/dd/admin/close/restaurant/addok.do">
            				<div class="row mb-3">
				                <label class="col-sm-2 col-form-label">식당명</label>
				                <div class="col-sm-10">
				                  	<select class="form-select" name="restaurant_seq" aria-label="Default select example">
				                    	<c:forEach items="${restaurantlist}" var="dto">
											<option value="${dto.restaurant_seq}" >${dto.name}</option>
										</c:forEach>
				                  	</select>
			                	</div>
			              	</div>
