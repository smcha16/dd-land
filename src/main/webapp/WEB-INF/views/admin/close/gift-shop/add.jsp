     		 ...
     		 <div class="col-lg-12">
        		...
        		<div class="card">
          			<div class="card-body">
            			...
            			<form method="POST" action="/dd/admin/close/gift-shop/addok.do">
            				<div class="row mb-3">
				                <label class="col-sm-2 col-form-label">기프트샵명</label>
				                <div class="col-sm-10">
				                  	<select class="form-select" name="shop_seq" aria-label="Default select example">
				                    	<c:forEach items="${shoplist}" var="dto">
											<option value="${dto.shop_seq}" >${dto.name}</option>
										</c:forEach>
				                  	</select>
			                	</div>
			              	</div>
