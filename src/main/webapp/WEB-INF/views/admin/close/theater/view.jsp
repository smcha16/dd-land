						...
						<div class="card">
                			<div class="card-body">
                  				...
                  				<nav class="d-flex justify-content-end">
                    				<ol class="breadcrumb">
                      					<li class="breadcrumb-item"><a href="/dd/admin/close/theater/add.do">추가</a></li>
                  				...
                  				<form id="del-form" method="POST" action="/dd/admin/close/theater/del.do">
                  				<table class="table">
                    				<thead>
                      					<tr>
                        					<th></th>
                    				...
                    				<tbody>
                    					<c:forEach items="${list}" var="dto" varStatus="numberStatus">
                      					<tr>
                        					<td><input type="checkbox" name="closeTheater_seq" value="${dto.theater_close_seq}"></td>
									...
									<c:forEach begin="1" end="${map.totalPages}" varStatus="pageStatus">
										<c:choose>
										    ...
										    <c:otherwise>
										        <li class="page-item"><a class="page-link" href="/dd/admin/close/theater/view.do?page=${pageStatus.index}">${pageStatus.index}</a></li>
										    </c:otherwise>
										</c:choose>
									</c:forEach>
								</ul>
...
<script>
	function edit() {  //수정
		...
		if (checkedCount !== 1) {
			...
			location.href='/dd/admin/close/theater/edit.do?seq=' + seq;  //1개 골랐으면 수정 페이지로 이동
		}
	}
