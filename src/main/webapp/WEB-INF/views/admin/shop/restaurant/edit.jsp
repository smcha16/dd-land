		...
		<nav class="d-flex justify-content-end">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a
					href="/dd/admin/shop/restaurant/view.do">취소</a></li>
			</ol>
		</nav>
	</div>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<form method="POST"
							action="/dd/admin/shop/restaurant/editok.do"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" id="name" name="name" class="form-control"
										placeholder="레스토랑명을 입력해주세요." value="${dto.name }" required>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<textarea id="info" name="menu" class="form-control"
										style="height: 100px" placeholder="레스토랑의 대표 메뉴들을 입력해주세요."
										required>${dto.menu }</textarea>
								</div>
							</div>

							<div class="row mb-3">
								<label for="time" class="col-sm-2 col-form-label required">운영
									시간</label>
								<div class="col-sm-10">
									<input type="text" id="time" name="time" class="form-control"
										placeholder="운영 시간(HH:MM - HH:MM)을 입력해주세요."
										value="${dto.time}" required>
									<div style="height: 30px;">
							...
							<div class="row mb-3">
								<label for="capacity" class="col-sm-2 col-form-label required">수용
									인원</label>
								<div class="col-sm-10">
									<input type="number" id="capacity" name="capacity"
										class="form-control" placeholder="수용 인원(숫자)을 입력해주세요."
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" id="tel" name="tel" class="form-control"
										placeholder="레스토랑 전화번호(070-XXXX-XXXX)를 입력해주세요."
										value="${dto.tel }" required>
									<div style="height: 30px;">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<div id="map" class="middle-flat"
										style="height: 380px; border-radius: var(- -bs-border-radius);"></div>
									<div style="height: 30px;">
									...
									<c:if test="${dto.img != 'attraction.png'}">
										<div>
	                  						<c:forEach items="${ilist}" var="dto">
	                  							<div class="attached"><i class="bi bi-image"></i> <c:out value="${dto.img}" /> <span onclick="delAttached(${dto.restaurant_img_seq})">&times;</span></div>
	                  						</c:forEach>
	                  					</div>
									</c:if>
								</div>
							...
							<!-- 어트랙션 seq -->
							<input type="hidden" name="restaurant_seq"
								value="${dto.restaurant_seq}">
