     		 ...
     		 <div class="col-lg-12">
        		...
        		<div class="card">
          			<div class="card-body">
						...
						<!-- 편의시설명, 전화번호, 위치, 이미지 -->
            			<form method="POST" action="/dd/admin/convenient/addok.do" enctype="multipart/form-data">
            	
              				<div class="row mb-3">
                				<label for="name" class="col-sm-2 col-form-label required">편의시설명</label>
                				<div class="col-sm-10">
                  					<input type="text" id="name" name="name" class="form-control" placeholder="편의시설명을 입력해주세요." required>
