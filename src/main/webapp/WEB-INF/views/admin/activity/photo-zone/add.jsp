     		 ...
     		 <div class="col-lg-12">
        		...
        		<div class="card">
          			<div class="card-body">
            			...
            			<form method="POST" action="/dd/admin/activity/photozone/addok.do" enctype="multipart/form-data">
            			
            				<!-- 포토존명 -->
              				<div class="row mb-3">
                				<label for="name" class="col-sm-2 col-form-label required">포토존명</label>
                				<div class="col-sm-10">
                  					<input type="text" id="name" name="name" class="form-control" placeholder="포토존명을 입력해주세요." required>
							...
							<!-- 포토존 소개 -->
              				<div class="row mb-3">
                				...
                				<div class="col-sm-10">
                  					<textarea id="info" name="info" class="form-control" style="height: 100px" placeholder="포토존의 소개 & 특징을 입력해주세요." required></textarea>
                				</div>
              				</div>
