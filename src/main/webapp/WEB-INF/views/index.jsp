...
<body>
		...
		<div class="container">
			<div class="row justify-content-between gy-5">
				<div
					...
					<p data-aos="fade-up" data-aos-delay="100">Sed autem laudantium
						dolores. Voluptatem itaque ea consequatur eveniet. Eum quas beatae
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row gy-4">
					<div class="col-lg-7 position-relative about-img"
						style="background-image: url(resources/img/about.jpg);"
					...
					<div class="tab-pane fade active show" id="menu-starters">
						...
						<div class="row gy-5">
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-1.png" class="glightbox"><img
									src="resources/img/menu/menu-item-1.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Magnam Tiste</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-2.png" class="glightbox"><img
									src="resources/img/menu/menu-item-2.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Aut Luia</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-3.png" class="glightbox"><img
									src="resources/img/menu/menu-item-3.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Est Eligendi</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-4.png" class="glightbox"><img
									src="resources/img/menu/menu-item-4.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Eos Luibusdam</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-5.png" class="glightbox"><img
									src="resources/img/menu/menu-item-5.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Eos Luibusdam</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/img/menu/menu-item-6.png" class="glightbox"><img
									src="resources/img/menu/menu-item-6.png"
									class="menu-img img-fluid" alt=""></a>
							...
							<div class="testimonial-item">
								<div class="row gy-4 justify-content-center">
									<div class="col-lg-6">
										<div class="testimonial-content">
											<p>
												<i class="bi bi-quote quote-icon-left"></i> Quis quorum
												...
												quid. <i class="bi bi-quote quote-icon-right"></i>
											</p>
											<h3>John Larson</h3>
											<h4>Entrepreneur</h4>
											<div class="stars">
				...
				<div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
					<div class="swiper-wrapper">
						...
						<div
							...
							style="background-image: url(resources/img/events-1.jpg)">
						...
						<div
							class="swiper-slide event-item d-flex flex-column justify-content-end"
							style="background-image: url(resources/img/events-2.jpg)">
						...
						<div
							class="swiper-slide event-item d-flex flex-column justify-content-end"
							style="background-image: url(resources/img/events-3.jpg)">
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row gy-4">
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch"
						...
						<div class="chef-member">
							<div class="member-img">
								<img src="resources/img/chefs/chefs-1.jpg" class="img-fluid"
									alt="">
								<div class="social">
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch"
						...
						<div class="chef-member">
							<div class="member-img">
								<img src="resources/img/chefs/chefs-2.jpg" class="img-fluid"
									alt="">
								<div class="social">
									<a href=""><i class="bi bi-twitter"></i></a> <a href=""><i
										class="bi bi-facebook"></i></a> <a href=""><i
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch"
						...
						<div class="chef-member">
							<div class="member-img">
								<img src="resources/img/chefs/chefs-3.jpg" class="img-fluid"
									alt="">
								<div class="social">
									<a href=""><i class="bi bi-twitter"></i></a> <a href=""><i
										class="bi bi-facebook"></i></a> <a href=""><i
					...
					<div class="swiper-wrapper align-items-center">
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-1.jpg"><img
								src="resources/img/gallery/gallery-1.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-2.jpg"><img
								src="resources/img/gallery/gallery-2.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-3.jpg"><img
								src="resources/img/gallery/gallery-3.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-4.jpg"><img
								src="resources/img/gallery/gallery-4.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-5.jpg"><img
								src="resources/img/gallery/gallery-5.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-6.jpg"><img
								src="resources/img/gallery/gallery-6.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-7.jpg"><img
								src="resources/img/gallery/gallery-7.jpg" class="img-fluid"
								alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="glightbox" data-gallery="images-gallery"
								href="resources/img/gallery/gallery-8.jpg"><img
								src="resources/img/gallery/gallery-8.jpg" class="img-fluid"
								alt=""></a>
						</div>
					</div>
					<div class="swiper-pagination"></div>
	...
	<footer id="footer" class="footer">
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>Yummy</span></strong>. All Rights
				Reserved
			</div>
			<div class="credits">
