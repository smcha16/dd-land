		...
		<div class="container">
			<div class="row justify-content-between gy-5">
				...
				<div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
					<img src="resources/main/img/hero-img.png" class="img-fluid" alt=""
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row gy-4">
					<div class="col-lg-7 position-relative about-img"
						style="background-image: url(resources/main/img/about.jpg);"
					...
					<div class="col-lg-5 d-flex align-items-end" data-aos="fade-up"
						...
						<div class="content ps-0 ps-lg-5">
							...
							<div class="position-relative mt-4">
								<img src="resources/main/img/about-2.jpg" class="img-fluid" alt="">
								<a href="https://www.youtube.com/watch?v=LXb3EKWsInQ"
					...
					<div class="tab-pane fade active show" id="menu-starters">
						...
						<div class="row gy-5">
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-1.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-1.png"
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-2.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-2.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Aut Luia</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-3.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-3.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Est Eligendi</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-4.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-4.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Eos Luibusdam</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-5.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-5.png"
									class="menu-img img-fluid" alt=""></a>
								<h4>Eos Luibusdam</h4>
								<p class="ingredients">Lorem, deren, trataro, filede, nerada
								</p>
							...
							<div class="col-lg-4 menu-item">
								<a href="resources/main/img/menu/menu-item-6.png" class="glightbox"><img
									src="resources/main/img/menu/menu-item-6.png"
									class="menu-img img-fluid" alt=""></a>
							...
							<div class="testimonial-item">
								<div class="row gy-4 justify-content-center">
									...
									<div class="col-lg-2 text-center">
										<img src="resources/main/img/testimonials/testimonials-1.jpg"
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<div class="row gy-4 justify-content-center">
									...
									<div class="col-lg-2 text-center">
										<img src="resources/main/img/testimonials/testimonials-2.jpg"
											class="img-fluid testimonial-img" alt="">
									</div>
								</div>
							</div>
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<div class="row gy-4 justify-content-center">
									...
									<div class="col-lg-2 text-center">
										<img src="resources/main/img/testimonials/testimonials-3.jpg"
											class="img-fluid testimonial-img" alt="">
									</div>
								</div>
							</div>
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<div class="row gy-4 justify-content-center">
									...
									<div class="col-lg-2 text-center">
										<img src="resources/main/img/testimonials/testimonials-4.jpg"
											class="img-fluid testimonial-img" alt="">
									</div>
								</div>
							</div>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row g-0">
					...
					<div class="col-lg-4 reservation-img"
						style="background-image: url(resources/main/img/reservation.jpg);"
